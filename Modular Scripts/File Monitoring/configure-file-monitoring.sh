...
#curl -k -s -o configure-linux.sh https://www.loggly.com/install/configure-linux.sh
...
curl -k -s -o configure-file-monitoring.sh https://github.com/psquickitjayant/install-script/raw/forcing/Modular%20Scripts/File%20Monitoring/configure-file-monitoring.sh
